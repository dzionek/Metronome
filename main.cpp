...
incorrectnumber:
	...
	case 1: std::system("cls");
		std::cout << "You chose the number (1), so please gimme the number of BMP I need to play.\nIt cannot be bigger than 300 BMP and less than 20 BMP.\n";
		float bmp;
	incorrectnumberbmp:
		std::cin >> bmp;
		if (std::cin.fail() || floor(bmp) != bmp || bmp>300 || bmp<20) {
